...
public class SecondNordeaApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            John John_characteristics = mapper.readValue(new File("data/John_Detail.json"), John.class);
            ...
            Address_John address_john = John_characteristics.getAddress();


            Bob Bob_Characteristics = mapper.readValue(new File("data/Bob_Detail.json"), Bob.class);
            Account account_2 = new Account(Bob_Characteristics.getInitial_balance_Bob());
            ...
            Address_Bob address_bob = Bob_Characteristics.getAddress();
            ...
            System.out.println("John initial balance: \n" + John_characteristics.getInitial_balance_John() + "\n");
            ...
            System.out.println("Bob initial balance: \n" + Bob_Characteristics.getInitial_balance_Bob() + "\n");
